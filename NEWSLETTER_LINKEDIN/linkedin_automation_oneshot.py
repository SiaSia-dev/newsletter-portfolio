...
class LinkedInNewsletterAutomation:
    ...
    def create_data_source(self):
        ...
        if not os.path.exists(self.data_source_path):
            ...
            "status": 'object',
            "jour_semaine": 'object',
            "date_formatee": 'object',
            "heure_formatee": 'object',
            "post_id": 'object'
        }
    ...
    def schedule_posts_from_newsletter(self, start_date=None):
        ...
        for i, project in enumerate(new_projects):
            ...
            hashtags = "\n\n#portfolio #contenu #automatisation #linkedin #newsletter #marketing"
...
if __name__ == "__main__":
    ...
    linkedin = LinkedInNewsletterAutomation(
        newsletter_path=args.custom_newsletter or args.newsletter,  # Utiliser custom_newsletter s'il est fourni
    ...
    # Utiliser start_date s'il est fourni
